    ...
    <div class="w-full max-w-lg">
        ...
        <div class="error-card bg-white rounded-2xl p-8 md:p-12 space-y-8">
            ...
            <div class="text-center space-y-3">
                <p class="text-sm font-semibold text-red-600 uppercase tracking-wide">Error 500</p>
                <h1 class="text-3xl font-bold text-gray-900">Error del Servidor</h1>
                <p class="text-base text-gray-600 leading-relaxed">
                    Algo salió mal de nuestro lado. Nuestro equipo ha sido notificado y estamos trabajando en resolverlo.
                </p>
            </div>
        ...
        <div class="text-center mt-8">
            ...
            <p class="text-xs text-gray-400 mt-2">Si el problema persiste, contacte a soporte técnico</p>
        </div>
    </div>
</body>
</html>
