...
<body class="flex items-center justify-center min-h-screen p-4 md:p-6 font-sans">
    <div class="w-full max-w-lg">
        ...
        <div class="error-card bg-white rounded-3xl p-8 md:p-12 space-y-8 border border-primary/5">
            ...
            <div class="text-center space-y-3">
                <div class="flex items-center justify-center space-x-2 mb-2">
                    ...
                    <p class="text-[10px] font-black text-primary uppercase tracking-[0.4em]">Error 419</p>
                </div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter">Sesión <span class="italic text-primary">Expirada</span></h1>
            ...
            <div class="flex flex-col gap-3 pt-6 border-t border-gray-50">
                <a href="{{ url('login') }}" class="flex items-center justify-center px-8 py-4 bg-primary text-white text-xs font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-primary/90 transition-all duration-300 shadow-lg shadow-primary/10 active:scale-95">
                    Reiniciar Sesión
                </a>
        ...
        <div class="text-center mt-10">
            ...
            <p class="text-[9px] font-bold text-gray-400 mt-3 uppercase tracking-widest opacity-60">Tu seguridad es importante para nosotros</p>
        </div>
    </div>
</body>
</html>
