...
<body class="flex items-center justify-center min-h-screen p-4 md:p-6 font-sans">
    <div class="w-full max-w-lg">
        ...
        <div class="error-card bg-white rounded-3xl p-8 md:p-12 space-y-8 border border-primary/5">
            ...
            <div class="text-center space-y-3">
                <div class="flex items-center justify-center space-x-2 mb-2">
                    ...
                    <p class="text-[10px] font-black text-primary uppercase tracking-[0.4em]">Error 404</p>
                </div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter">Página No <span class="italic text-primary">Encontrada</span></h1>
        ...
        <div class="text-center mt-10">
            ...
            <p class="text-[9px] font-bold text-gray-400 mt-3 uppercase tracking-widest opacity-60">Si necesitas ayuda, contacta a soporte técnico</p>
        </div>
    </div>
</body>
</html>
