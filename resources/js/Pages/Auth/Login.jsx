        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#fdfcf9] font-sans selection:bg-primary selection:text-white p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-[420px] z-10 lighthouse-wrapper">
                ...
                <div className="rounded-2xl lighthouse-card border border-gray-100 overflow-hidden relative">
                    <div className="p-8 md:p-10">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-400 font-medium text-sm">Gestiona la seguridad de tu plataforma</p>
                        </div>

                        {/* Mensajes de Estado */}
                        <div className="space-y-4 mb-6">
                            {status && (
                                <div className="p-4 bg-blue-50/50 border border-blue-100 rounded-xl text-xs font-bold text-blue-600 animate-fade-in flex items-center gap-3">
                            ...
                            {usePage().props.flash?.error && (
                                <div className="p-4 bg-red-50/50 border border-red-100 rounded-xl text-xs font-bold text-red-600 animate-fade-in flex items-center gap-3">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="space-y-2 searchlight-field">
                                <div className="flex justify-between items-center ms-0.5">
                                    ...
                                    {canResetPassword && (
                                        <Link href={route('password.request')} className="text-[10px] text-primary hover:text-black font-black uppercase tracking-tighter transition-colors">
                                            Recuperar
                                        </Link>
                                    )}
                                </div>
                            ...
                            <div className="flex items-center ms-0.5 pt-1">
                                <label className="flex items-center cursor-pointer group">
                                    <Checkbox
                                        role="presentation" // Para que herede el estilo de nuestro componente Checkbox
                                        name="remember"
                                        checked={data.remember}
                                        onChange={(e) => setData('remember', e.target.checked)}
                                    />
                                    <span className="ms-3 text-[10px] text-gray-400 group-hover:text-primary transition-colors font-black uppercase tracking-widest">
                                        Recordar equipo
                                    </span>
                                </label>
                            </div>
                            ...
                            <div className="pt-2">
                                <PrimaryButton 
                                    className="w-full justify-center py-4 rounded-xl shadow-lg shadow-primary/10 hover:shadow-primary/20 active:scale-[0.98] transition-all bg-primary hover:bg-[#07104d] text-white text-xs font-black uppercase tracking-[0.2em]" 
                                    disabled={processing}
                                >
                                    Acceder al Sistema
                                </PrimaryButton>
                            ...
                            <div className="relative py-2 px-10">
                                ...
                                <div className="relative flex justify-center text-[8px]">
                                    <span className="px-3 bg-white text-gray-300 font-black uppercase tracking-[0.3em]">o acceso rápido</span>
                                </div>
                            </div>

                            <a
                                href={route('auth.google')}
                                className="w-full inline-flex items-center justify-center gap-3 py-3.5 px-6 rounded-xl border border-gray-100 bg-white hover:bg-gray-50 active:scale-[0.98] transition-all group"
                            >
                                ...
                                <span className="text-gray-500 font-bold group-hover:text-primary transition-colors text-[10px] uppercase tracking-widest">
                                    Google Auth
                                </span>
                            </a>
                        </form>
                ...
                <div className="text-center mt-10">
                    <p className="text-[9px] text-gray-300 uppercase tracking-[0.5em] font-black">
