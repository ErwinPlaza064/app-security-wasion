                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-12 flex items-center justify-between">
                        <div>
                            ...
                            <h1 className="text-4xl font-black text-gray-900 tracking-tighter uppercase">Recorrido de Planta</h1>
                        </div>
                        <div className={`w-16 h-16 rounded-[2rem] bg-white shadow-xl flex items-center justify-center transition-all duration-500 ${isRunning ? 'text-primary scale-110' : 'text-gray-300'}`}>
                            <svg className={`w-8 h-8 ${isRunning ? 'animate-spin-slow' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {patrolState === 'idle' && (
                            <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-[0_20px_50px_rgb(0,0,0,0.03)] text-center space-y-8">
                                <div className="space-y-4">
                                    ...
                                    <h2 className="text-xl font-black text-gray-900 uppercase tracking-tight">Listo para comenzar</h2>
                                    <p className="text-sm text-gray-400 font-medium max-w-xs mx-auto">Presione el botón para iniciar el cronómetro y comenzar su recorrido de seguridad.</p>
                                </div>
                                <button
                                    onClick={startPatrol}
                                ...
                                >
                                    ...
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 5l7 7-7 7M5 5l7 7-7 7" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/></svg>
                                </button>
                            </div>
                        )}
                        ...
                        {patrolState === 'running' && (
                            <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-[0_20px_50px_rgb(0,0,0,0.03)] text-center space-y-10">
                                <div className="space-y-2">
                                    <span className="text-[10px] font-black text-primary tracking-[0.5em] uppercase">Recorrido en Progreso</span>
                                    <div className="text-7xl font-black text-gray-900 tracking-tighter tabular-nums py-4">
                                        {formatTime(seconds)}
                                    </div>
                                    <div className="flex items-center justify-center space-x-2">
                                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                                        <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Cronómetro Activo</span>
                                    </div>
                                </div>
                            ...
                            <form onSubmit={submit} className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
                                <div className="bg-white p-10 rounded-[3.5rem] border border-gray-100 shadow-[0_20px_50px_rgb(0,0,0,0.03)] space-y-8">
                                    <div className="flex items-center justify-between border-b border-gray-50 pb-6">
                                        <div>
                                            <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Resumen del Recorrido</h2>
                                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Capture hallazgos antes de guardar</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-1">Tiempo Total</p>
                                            <p className="text-2xl font-black text-gray-900">{formatTime(seconds)}</p>
                                        </div>
                                    </div>
