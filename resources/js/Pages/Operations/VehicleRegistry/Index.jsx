                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 relative group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg
                                className="h-5 w-5 text-gray-300 group-focus-within:text-blue-500 transition-colors"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-6">
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <span
                                                                className={`px-2.5 py-1 rounded-lg border text-[9px] font-black tracking-widest ${colorClass}`}
                                                            >
                                                ...
                                                <td className="px-8 py-6 text-right">
                                                    <div className="flex items-center justify-end space-x-2">
                                                        <span
                                                            className="p-2 rounded-lg bg-gray-50 text-gray-300"
                                                            title="Solo consulta"
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
