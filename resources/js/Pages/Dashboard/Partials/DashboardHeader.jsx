export default function DashboardHeader({ operatorName, activePersonsPercent, activeVehiclesPercent, activePersons, activeVehicles, activeResignations, activeTab, onTabChange }) {
    return (
        <div className="mb-10 flex flex-col lg:flex-row lg:items-end justify-between gap-8 border-b border-gray-100 pb-12 uppercase">
            ...
            <div className="flex flex-col items-center space-y-4">
                <div className="flex flex-col items-center mb-2">
                    <span className="text-sm font-black text-gray-400 tracking-[0.8em] uppercase text-center">Visitantes Dentro</span>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    ...
                    >
                        <div className="flex flex-col items-start">
                            <span className="text-[10px] font-black text-gray-400 tracking-widest uppercase mb-1">Personas</span>
                            <div className="flex items-center space-x-2">
                                <span className="text-2xl font-black text-primary leading-none">{activePersons}</span>
                            </div>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex flex-col items-start">
                            <span className="text-[10px] font-black text-gray-400 tracking-widest uppercase mb-1">Vehículos</span>
                            <div className="flex items-center space-x-2">
