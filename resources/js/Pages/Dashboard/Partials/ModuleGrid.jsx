    ...
    return (
        <div className="space-y-6 mb-16">
            <div className="flex items-center justify-center lg:justify-between px-1">
                <h2 className="text-[10px] font-black text-gray-900 uppercase tracking-[0.2em] text-center lg:text-left">Acciones de Registro</h2>
            </div>
                ...
                {filteredModules.length > 0 ? (
                    filteredModules.map((item) => (
                        <Link
                            ...
                            className="group bg-white p-7 rounded-[2.5rem] border border-gray-100/60 shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_50px_rgb(12,24,105,0.06)] transition-all duration-500 flex flex-col items-center lg:items-start min-h-[180px] justify-between overflow-hidden relative"
                        >
                            ...
                            <div className="relative z-10 w-full text-center lg:text-left flex flex-col items-center lg:items-start">
                                ...
                                <div className="flex items-center justify-center lg:justify-start space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
