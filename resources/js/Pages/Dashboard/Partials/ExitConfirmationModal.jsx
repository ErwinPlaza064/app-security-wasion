        ...
        <Modal show={show} onClose={() => { setSignature(''); onClose(); }} maxWidth="md">
            <div className="p-6 md:p-8 max-h-[90vh] overflow-y-auto custom-scrollbar">
                ...
                <div className="text-center space-y-3 mb-6">
                    <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Confirmar Salida</h2>
                    <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                        <p className="text-[9px] text-gray-400 font-black uppercase tracking-[0.2em] mb-1">Se registrará la salida para:</p>
                        <p className="text-sm font-black text-primary uppercase leading-tight">{name}</p>
                        <p className="text-[10px] font-bold text-gray-500 mt-0.5">{company}</p>
                    </div>
                </div>
